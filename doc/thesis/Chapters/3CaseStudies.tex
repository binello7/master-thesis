...
The rain intensity was kept constant and was uniformly applied over the domain, also since \citetalias{delestre_fullswof:_2017}, at this stage of development, only allows for uniformly distributed rain \autocite{laguerre_documentation_2016}.
...
To build the \emph{time-to-threshold emulator}, the emulator giving the lapse of time $t_!$ passed from the beginning of the rain event to the exceeding of the threshold discharge $Q_!$, a threshold discharge has to be established.
