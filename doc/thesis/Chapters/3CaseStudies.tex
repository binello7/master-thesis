...
All simulated pairs $(Q, h_w)$ constitute an observational \emph{predictor-response} set to which the weir equation was fitted.
 \seb{give e.g. in Appendix the discharge values used?}\\
...
%...............................................................................
\subsubsection{Compute the error}\label{sec:compute_error}
%...............................................................................
...
By reducing the number of points, the error of this model increases exponentially.
...
By increasing this distance these chances decrease quite fast, since the cubic spline interpolation is not a very suitable model to describe the behavior of the process.
...
Because interpolation cannot be obtained, it error decreases very slowly with increasing number of points.
...
It shows almost no decline in performance with reducing number of points.
...
From this example the importance of the equilibrium \emph{prior knwoledge} -- \emph{data availability} can be seen.
...
When obtaining new observations is computationally very costly, like it is the case with some simulations, "interpolation methods" allowing the encoding of prior knowledge can turn out to be very useful.
...
If the information embedded is correct the result will be very similar to the one observed with the weir equation: it does not matter how many points are available, the results will still be good.
If the model of the process is found, no more observation are needed.
These are simply given by the evaluation of the model.
