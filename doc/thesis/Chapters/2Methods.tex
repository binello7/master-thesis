...
The package \citetalias{rasmussen_gaussian_2010} offers a set of mean, covariance and likelihood functions as well as various prior distribution and inference methods readily available for to the user.
