...
% * as intro state clearly what I present here (Jorg)
...
Initial values have to be attributed to all of the hyperparameters needed, then the real value must be found by optimization with the function \emph{minimize} of the same package.\seb{mention this /integrate in text!!}
...
\seb{mention FullSWOF solves Finite Volumes!!}
...
\seb{mention somewhere that fswof2d package was used in both case studies}
