...
\section{Case study 1: weir equation}
  ...
  \begin{frame}
    ...
    \textbf{Goal}: learn the weir equation from simulated data\\
    \begin{alertblock}{Weir equation}
      \setlength\abovedisplayskip{0pt}
      \begin{equation*}
        Q = \frac{2}{3}\: \textcolor{red}{\mu}\: B_w\: \sqrt{2g}\: h_{\"u}^{\textcolor{red}{a}},
...
%   is needed.
% * In order to obtain actual discharge it has to be accounted for correction of
%   velocity distribution
% * This is done by adding a coefficient C_d (or \mu) in front of the equation, which
%   is dependent on the type and shape of weir
