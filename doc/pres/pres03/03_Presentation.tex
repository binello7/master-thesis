...
\subtitle{First steps for the application of emulation in \emph{flood prediction}}
...
% * The  linear fit always performs the worst, although not even that bad: RMS of ~2cm
%   leaving out 1 point.
...
% * Measures have to be taken in this case, build up temporary flood-blocking measures,
%   evacuate people, etc.
...
% CASE STUDY 2: STUDY SET-UP
  \begin{frame}
    \frametitle{Experiment overview}
    \centering
    \includegraphics[width=0.5\textwidth]{img/topography.png}
