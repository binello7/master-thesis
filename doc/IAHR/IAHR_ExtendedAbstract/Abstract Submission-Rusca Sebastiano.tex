...
\author{{S. Rusca} \\
{\aff{Swiss Federal Institute of Aquatic Science and Technology, Eawag, Überlandstrasse 133, 8600 Dübendorf, Switzerland}} \\\\
...
We present an catchment specific emulator based on non-linear shallow water equations to be used
for flood early warning system in realtime.
...
Numerical models are useful tools to predict floods and trigger security measures or evacuations. However, the high computation demands of these models hinders their use in realtime early warning systems.
