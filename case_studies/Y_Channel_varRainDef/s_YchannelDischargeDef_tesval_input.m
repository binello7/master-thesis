...
rain_intensities_val  =[25 31 36]; #[mm/h]
...
vnri  = length (rain_intensities_val);
vnsat = length (soil_saturations_val);
...
for i = 1:vnri
  ...
  for s = 1:vnsat
    ...
    params = params2file ('xCells', Nx, ...
                          ...
                          'HydrCondCrustCoef', Ks, ...
                          'HydrCondSoilCoef', Ks, ...
                          'WaterContentVal', soil_saturations_val(s), ...
                          'WetFrontSuccHeadVal', psi_f, ...
                          'MaxInfiltrationRateVal', 5.5e-6, ...
                          'RainFile', rainfile, ...
                          'OutputsSuffix', suffix, ...
